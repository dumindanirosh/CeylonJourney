<%-- 
    ...
    Created on : Dec 18, 2012, 11:47:09 AM
    Author     : Duminda
--%>
            ...
            <div id="content">
                ...
                <div id="content_right">
                    ...
                    <form id="loadLocationDataForm" name="loadLocationDataForm" action="viewSelectedLocation.action">
                        ...
                        <input type="hidden" name="actionType" value="<%=BackendConstants.LOCATION_FOR_DASHBOARD_DELETE%>"/>
                    </form>
                    ...
                    %>
                    <form action="/CeylonJourney/locationController.action?actionType=deleteLocation" method="post">
