<%-- 
    ...
    Created on : Dec 18, 2012, 11:40:55 AM
    Author     : Duminda
--%>
            ...
            <div id="content">
                ...
                <div id="content_right">
                    ...
                    <form id="loadLocationDataForm" name="loadLocationDataForm" action="viewSelectedLocation.action">
                        ...
                        <input type="hidden" name="actionType" value="<%=BackendConstants.LOCATION_FOR_DASHBOARD_VIEW%>"/>
                    </form>
                    ...
                    %>
                    <form action="/CeylonJourney/location/locationManagement.jsp">
