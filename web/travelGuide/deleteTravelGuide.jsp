<%-- 
    Document   : deleteTravelGuide
    Created on : Feb 13, 2013, 4:07:18 PM
    Author     : Duminda
--%>
...
<html>
    <head>
        ...
        <title>Delete Travel Guide</title>
        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div id="content_right">
                    ...
                    %>
                    <form action="/CeylonJourney/travelGuideManagement.action?actionType=deleteGuide" method="post">
                        <table border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="submit" value="Delete Guide" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
