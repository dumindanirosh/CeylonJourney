...
<html>
    <head>
        ...
        <title>Add Hotel Contract</title>
            ...
            <div id="content">
                ...
                <div id="content_right">
                    ...
                    <form id="loadHotelDataForm" name="loadHotelDataForm" action="viewSelectedHotel.action">
                        ...
                        <input type="hidden" name="actionType" value="<%=BackendConstants.HOTEL_FOR_ADD_CONTRACT%>"/>
                    </form>
                    ...
                    <form action="/CeylonJourney/hotelContractController.action?actionType=addContract" method="post">
