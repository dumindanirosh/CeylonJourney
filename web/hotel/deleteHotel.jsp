            ...
            <div id="content">
                ...
                <div id="content_right">
                    ...
                    <form id="loadHotelDataForm" name="loadHotelDataForm" action="viewSelectedHotel.action">
                        ...
                        <input type="hidden" name="actionType" value="<%=BackendConstants.HOTEL_FOR_DASHBOARD_DELETE%>"/>
                    </form>
                    ...
                    <form action="/CeylonJourney/hotelController.action?actionType=deleteHotel" method="post">
