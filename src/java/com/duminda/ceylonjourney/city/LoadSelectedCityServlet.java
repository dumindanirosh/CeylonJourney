...
/**
 * This servlet detects the selected CityDetail from the JSP which calls this
 * servlet and return back the selected CityDetail to that JSP.
 *
 * @author Duminda
 */
public class LoadSelectedCityServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            request.setAttribute(BackendConstants.SELECTED_CITY, cityDetail);
            String actionType = request.getParameter("actionType");

            RequestDispatcher requestDispatcher = null;
            if (actionType.equals(BackendConstants.UPDATE)) {
                requestDispatcher =
                        request.getRequestDispatcher("/city/updateCity.jsp");

            } else if (actionType.equals(BackendConstants.DELETE)) {
                requestDispatcher =
                        request.getRequestDispatcher("/city/deleteCity.jsp");
            } else if (actionType.equals(BackendConstants.VIEW)) {
                requestDispatcher =
                        request.getRequestDispatcher("/city/viewCity.jsp");
