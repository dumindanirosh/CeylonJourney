...
/**
 * The sign out function is handled by this servlet. This servlet stops the
 * current user session and returns the browser to Home page.
 *
 * @author Duminda
 */
public class SignoutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            session.removeAttribute(BackendConstants.USER);
            session.invalidate();
