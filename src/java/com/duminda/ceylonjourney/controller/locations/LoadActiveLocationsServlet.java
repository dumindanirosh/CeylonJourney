...
/**
 * This servlet serves to the Home page by loading the active locations and send them as a List of Locations.
 * @author Duminda
 */
public class LoadActiveLocationsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/location/viewActiveLocationsHome.jsp");
