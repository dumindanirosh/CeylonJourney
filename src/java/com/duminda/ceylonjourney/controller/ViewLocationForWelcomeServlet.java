...
/**
 * The Home page needs to load the active locations in-oreder to create the thumbnail shots.
 * This servlet loads the active locations' List and pass it to the Home page.
 * @author Duminda
 */
public class ViewLocationForWelcomeServlet extends HttpServlet {
